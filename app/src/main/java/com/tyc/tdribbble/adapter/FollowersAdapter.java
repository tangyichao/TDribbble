...
public class FollowersAdapter extends RecyclerView.Adapter<FollowersAdapter.FollowersViewHolder> {
    ...
    public void onBindViewHolder(final FollowersViewHolder holder, final int position) {
        Glide.with(context).load(followersEntities.get(position).getFollower().getAvatarUrl()).placeholder(R.drawable.bg_default_avatar).error(R.drawable.bg_default_avatar).into(holder.mTvAvatar);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("user", followersEntities.get(position).getFollower());
